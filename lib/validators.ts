...
export const adminRouteSchema = z.object({
  ...
  policyNotes: z.string().trim().optional().default(""),
...
export const adminVehicleTypeSchema = z.object({
  ...
  bestFor: z.string().trim().optional().default(""),
  imageUrl: z.string().trim().optional().default(""),
  featuredImageUrl: z.string().trim().optional().default(""),
  privacyScore: z.coerce.number().int().min(0).max(5).default(0),
  comfortScore: z.coerce.number().int().min(0).max(5).default(0),
  valueScore: z.coerce.number().int().min(0).max(5).default(0),
...
export const adminSearchUiLabelsSchema = z.object({
  ...
  tripFitScore: localeLabelSchema,
  tripAiNotePrefix: localeLabelSchema,
  tripRatingReason: localeLabelSchema,
  tripVerifiedReason: localeLabelSchema,
  tripComfortReason: localeLabelSchema,
  tripPickupReason: localeLabelSchema,
  tripSeatsReason: localeLabelSchema,
  tripRoute: localeLabelSchema,
  tripTourist: localeLabelSchema,
  tripPickup: localeLabelSchema,
  tripDropoff: localeLabelSchema,
  routeMapTitle: localeLabelSchema,
  routeInfoTitle: localeLabelSchema,
