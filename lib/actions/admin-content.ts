...
export async function updateSearchUiLabelsAction(formData: FormData) {
  ...
  const parsed = adminSearchUiLabelsSchema.parse({
    ...
    routeOverview: readLocaleMap(formData, "routeOverview"),
    routeSelectedTrip: readLocaleMap(formData, "routeSelectedTrip"),
    routeDistance: readLocaleMap(formData, "routeDistance"),
    routeDuration: readLocaleMap(formData, "routeDuration"),
    routeAverageDuration: readLocaleMap(formData, "routeAverageDuration"),
    routeCommonRoad: readLocaleMap(formData, "routeCommonRoad"),
    routeLocationWillBeConfirmed: readLocaleMap(formData, "routeLocationWillBeConfirmed"),
    routeInternationalRoute: readLocaleMap(formData, "routeInternationalRoute"),
    routeBorderDocumentNote: readLocaleMap(formData, "routeBorderDocumentNote"),
    routeBorderSupport: readLocaleMap(formData, "routeBorderSupport"),
    routeViewLargeMap: readLocaleMap(formData, "routeViewLargeMap"),
    routeOpenGoogleMaps: readLocaleMap(formData, "routeOpenGoogleMaps"),
    routeViewOnMap: readLocaleMap(formData, "routeViewOnMap"),
    routePickupPoint: readLocaleMap(formData, "routePickupPoint"),
    routeDropoffPoint: readLocaleMap(formData, "routeDropoffPoint"),
    routeArriveEarly: readLocaleMap(formData, "routeArriveEarly"),
    routeMinutesBefore: readLocaleMap(formData, "routeMinutesBefore"),
    routeViewTripDetails: readLocaleMap(formData, "routeViewTripDetails"),
    routeSeatsLeft: readLocaleMap(formData, "routeSeatsLeft"),
    routePerPassenger: readLocaleMap(formData, "routePerPassenger"),
    routeVerified: readLocaleMap(formData, "routeVerified"),
  ...
  const value = {
    ...
    routePanel: {
      ...
      routeOverview: parsed.routeOverview,
      selectedTrip: parsed.routeSelectedTrip,
      distance: parsed.routeDistance,
      duration: parsed.routeDuration,
      averageDuration: parsed.routeAverageDuration,
      commonRoad: parsed.routeCommonRoad,
      ...
      locationWillBeConfirmed: parsed.routeLocationWillBeConfirmed,
      internationalRoute: parsed.routeInternationalRoute,
      borderDocumentNote: parsed.routeBorderDocumentNote,
      borderSupport: parsed.routeBorderSupport,
      viewLargeMap: parsed.routeViewLargeMap,
      openGoogleMaps: parsed.routeOpenGoogleMaps,
      viewOnMap: parsed.routeViewOnMap,
      pickupPoint: parsed.routePickupPoint,
      dropoffPoint: parsed.routeDropoffPoint,
      arriveEarly: parsed.routeArriveEarly,
      minutesBefore: parsed.routeMinutesBefore,
      viewTripDetails: parsed.routeViewTripDetails,
      seatsLeft: parsed.routeSeatsLeft,
      perPassenger: parsed.routePerPassenger,
      verified: parsed.routeVerified,
    },
