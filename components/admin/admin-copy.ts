...
export const adminCopy: Record<Locale, AdminCopy> = {
  en: {
    ...
    texts: {
      ...
      "Settings description": "Settings have been split into subpages for easier management, avoiding a very long screen.",
      "View website": "View website",
      "Database missing content table": "Database is missing the new Website Content table. Please run the migration and try saving again.",
      "Header": "Header",
      "Header description": "Logo, site name and multilingual public header tagline.",
      "Homepage content": "Homepage content",
      "Homepage description": "Hero, search suggestions, need cards and homepage blocks.",
      "Vehicle page": "Vehicle page",
      "Vehicle page description": "Banner image and public vehicle page asset settings.",
      "Payment description": "Payment providers, bank QR, VNPay, Stripe and checkout availability.",
      "Policy": "Policy",
      "Policy description": "Public policy pages for booking, cancellation, payment and support.",
      "Footer": "Footer",
      "Footer description": "Footer description, contact phones, social links and groups.",
      "Search labels": "Search labels",
      "Search labels description": "Multilingual labels for search, filters, trip cards and badges.",
  ...
  vi: {
    ...
    texts: {
      ...
      "Settings description": "Cài đặt đã được tách thành từng trang con để dễ quản lý, tránh một màn hình quá dài.",
      "View website": "Xem website",
      "Database missing content table": "Database chưa có bảng Website Content mới. Hãy chạy migration rồi thử lưu lại.",
      "Header": "Đầu trang",
      "Header description": "Logo, tên trang web và khẩu hiệu công khai đa ngôn ngữ.",
      "Homepage content": "Trang chủ",
      "Homepage description": "Nội dung phần Hero, gợi ý tìm kiếm, thẻ nhu cầu và các khối trang chủ.",
      "Vehicle page": "Trang loại xe",
      "Vehicle page description": "Hình ảnh banner và cài đặt tài nguyên công khai của trang loại xe.",
      "Payment description": "Nhà cung cấp thanh toán, QR ngân hàng, VNPay, Stripe và cài đặt thanh toán.",
      "Policy": "Chính sách",
      "Policy description": "Trang chính sách công khai cho đặt vé, đổi/hủy, thanh toán và hỗ trợ.",
      "Footer": "Cuối trang",
      "Footer description": "Mô tả cuối trang, số điện thoại liên hệ, liên kết mạng xã hội và các nhóm.",
      "Search labels": "Nhãn tìm kiếm",
      "Search labels description": "Nhãn đa ngôn ngữ cho tìm kiếm, bộ lọc, thẻ chuyến đi và huy hiệu.",
  ...
  ko: {
    ...
    texts: {
      ...
      "Settings description": "관리를 쉽게 하고 화면이 길어지는 것을 방지하기 위해 설정이 하위 페이지로 분할되었습니다.",
      "View website": "웹사이트 보기",
      "Database missing content table": "데이터베이스에 새 Website Content 테이블이 없습니다. 마이그레이션을 실행하고 다시 시도하세요.",
      "Header": "헤더",
      "Header description": "로고, 사이트 이름 및 다국어 공개 헤더 태그라인.",
      "Homepage content": "홈페이지",
      "Homepage description": "히어로 섹션, 검색 제안, 요구 사항 카드 및 홈페이지 블록.",
      "Vehicle page": "차량 페이지",
      "Vehicle page description": "배너 이미지 및 공개 차량 페이지 자산 설정.",
      "Payment description": "결제 제공업체, 은행 QR, VNPay, Stripe 및 결제 가능 여부.",
      "Policy": "정책",
      "Policy description": "예약, 취소, 결제 및 지원을 위한 공개 정책 페이지.",
      "Footer": "푸터",
      "Footer description": "푸터 설명, 연락처, 소셜 링크 및 그룹.",
      "Search labels": "검색 라벨",
      "Search labels description": "검색, 필터, 여행 카드 및 배지를 위한 다국어 라벨.",
      "Open settings": "설정 열기",
    },
  },
  ja: {
    ...
    texts: {
      ...
      "Settings description": "管理を容易にし、画面が長くなるのを防ぐため、設定はサブページに分割されています。",
      "View website": "ウェブサイトを表示",
      "Database missing content table": "データベースに新しい Website Content テーブルがありません。マイグレーションを実行して再試行してください。",
      "Header": "ヘッダー",
      "Header description": "ロゴ、サイト名、多言語の公開ヘッダータグライン。",
      "Homepage content": "ホームページ",
      "Homepage description": "ヒーローセクション、検索候補、要件カード、ホームページブロック。",
      "Vehicle page": "車両ページ",
      "Vehicle page description": "バナー画像および公開車両ページアセット設定。",
      "Payment description": "決済プロバイダー、銀行QR、VNPay、Stripe、およびチェックアウトの可用性。",
      "Policy": "ポリシー",
      "Policy description": "予約、キャンセル、支払い、サポートに関する公開ポリシーページ。",
      "Footer": "フッター",
      "Footer description": "フッターの説明、連絡先電話番号、ソーシャルリンク、グループ。",
      "Search labels": "検索ラベル",
      "Search labels description": "検索、フィルター、トリップカード、バッジ用の多言語ラベル。",
      "Open settings": "設定を開く",
    },
  },
};
